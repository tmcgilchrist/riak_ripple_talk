{application,riak_search,
             [{description,"Riak Search"},
              ...
              {modules,[basho_bench_driver_riaksearch,merge_index_backend,
                        ...
                        riak_search_operators_qc,riak_search_repl_helper,
                        riak_search_ring_utils,riak_search_schema,
                        riak_search_schema_parser,riak_search_sup,
                        riak_search_test,riak_search_utils,riak_search_vnode,
                        riak_search_vnode_sup,riak_solr_indexer_wm,
                        riak_solr_output,riak_solr_qc,riak_solr_search_client,
                        riak_solr_searcher_wm,riak_solr_sort,riak_solr_sup,
                        riak_solr_xml,riak_solr_xml_xform,search,solr_search,
                        text_analyzers]}]}.
